...
class spi_data_t(object):
    __slots__ = ["q_abad", "q_hip", "q_knee", "qd_abad", "qd_hip", "qd_knee", "tau_abad", "tau_hip", "tau_knee", "flags", "spi_driver_status"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "int32_t", "int32_t"]

    __dimensions__ = [[4], [4], [4], [4], [4], [4], [4], [4], [4], [4], None]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x8ac2c42b6af910b5) & 0xffffffffffffffff
