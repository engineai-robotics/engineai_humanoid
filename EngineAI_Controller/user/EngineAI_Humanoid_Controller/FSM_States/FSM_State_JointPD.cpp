...
void FSM_State_JointPD<T>::onEnter()
{
    ...
    printf("[FSM JOINTPD] On Enter\n");
    std::cout << "[FSM BALANCESTAND] joint des pos :" << this->_data->controlParameters->straight_stand_jpos[0] << " " << this->_data->controlParameters->straight_stand_jpos[1] << " " << this->_data->controlParameters->straight_stand_jpos[2] << std::endl;
}
...
void FSM_State_JointPD<T>::run()
{
    ...
    qDes << 0.0, 0.0, this->_data->controlParameters->straight_stand_jpos[0], this->_data->controlParameters->straight_stand_jpos[1], this->_data->controlParameters->straight_stand_jpos[2], this->_data->controlParameters->straight_stand_jpos[2],
        0.0, 0.0, this->_data->controlParameters->straight_stand_jpos[0], this->_data->controlParameters->straight_stand_jpos[1], this->_data->controlParameters->straight_stand_jpos[2], this->_data->controlParameters->straight_stand_jpos[2];

    Vec12<T> kp_stance;
    // kp_stance << 120, 120, 120, 120, 80, 80, 120, 120, 120, 120, 80, 80;stand_joint_kp
